...
public class WorldChunkManagerEmpyrean extends WorldChunkManager {

    public static final BiomeGenBase[] biomeList = new BiomeGenBase[256];

	public static final BiomeGenBase empyrean = (new BiomeGenEmpyrean(Config.empyreanBiomeID)).setBiomeName("Empyrean").setColor(10526880).setEnableSnow().setMinMaxHeight(0.3F, 1.3F).setTemperatureRainfall(0.0F, 0.5F);;


    public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(empyrean));
	...
	public static void init() {
		for(int i = 0; i < 256; ++i) {
			biomeList[i] = empyrean;
		}
	}

	protected WorldChunkManagerEmpyrean()
    {
    ...
    public WorldChunkManagerEmpyrean(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public WorldChunkManagerEmpyrean(World par1World)
    {
