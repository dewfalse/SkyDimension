...
public class WorldChunkManagerSky extends WorldChunkManager {
	...
	public static final BiomeGenBase sky = (new BiomeGenSky(Config.skyBiomeID)).setBiomeName("Sky").setColor(10526880).setEnableSnow().setMinMaxHeight(0.3F, 1.3F).setTemperatureRainfall(0.0F, 0.5F);;


    public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(sky));
